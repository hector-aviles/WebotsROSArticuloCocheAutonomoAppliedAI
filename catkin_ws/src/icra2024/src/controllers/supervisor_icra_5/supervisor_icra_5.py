...
def main():
    ...
    cars = [robot.getFromDef('1'), robot.getFromDef('2'),
            robot.getFromDef('3' ), robot.getFromDef('4'),  robot.getFromDef('5')]
    ...
    pub_bmw_pose  = rospy.Publisher('/self_driving_pose', Pose2D, queue_size=10)
