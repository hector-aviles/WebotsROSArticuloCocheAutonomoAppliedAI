...
robot.getFromDef('vehicle_3'), robot.getFromDef('vehicle_4'),  robot.getFromDef('vehicle_5'), robot.getFromDef('vehicle_6'), robot.getFromDef('vehicle_7'), robot.getFromDef('vehicle_8'), robot.getFromDef('vehicle_9'), robot.getFromDef('vehicle_10')]
    ...
    pub_bmw_pos  = rospy.Publisher("/self_driving_pos", Pose2D, queue_size=1)
    pub_car_1_pos  = rospy.Publisher("/car_1_pos", Pose2D, queue_size=1)
    pub_car_2_pos  = rospy.Publisher("/car_2_pos", Pose2D, queue_size=1)
    pub_car_3_pos  = rospy.Publisher("/car_3_pos", Pose2D, queue_size=1)
    pub_car_4_pos  = rospy.Publisher("/car_4_pos", Pose2D, queue_size=1)
    pub_car_5_pos  = rospy.Publisher("/car_5_pos", Pose2D, queue_size=1)
    pub_car_6_pos  = rospy.Publisher("/car_6_pos", Pose2D, queue_size=1)
    pub_car_7_pos  = rospy.Publisher("/car_7_pos", Pose2D, queue_size=1)
    pub_car_8_pos  = rospy.Publisher("/car_8_pos", Pose2D, queue_size=1)
    pub_car_9_pos  = rospy.Publisher("/car_9_pos", Pose2D, queue_size=1)
    pub_car_10_pos  = rospy.Publisher("/car_10_pos", Pose2D, queue_size=1)
